...
class LogisticRegression(bias=False):
    ...
    def fit(self, x, y, lr, b, epochs, log=100, verbose=True):
        ...
        m = x.shape[1]                                  # tendremos un peso por features
        ...
        for epoch in range(epochs):
            ...
            if verbose:
                if epoch % log == 0:
                    print("Epoch: {}, Loss: {}".format(epoch, l_epoch))
